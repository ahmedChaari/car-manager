            ...
            <div class="information__block py-4 lg:py-4 px-4 lg:px-8">
                <form method="POST" action="{{ route('complet-car-information.store-step1', ['id' => $car->id]) }}">
                    ...
                    <div class="description__field w-full mt-5 md:mt-8">
                        ...
                        <textarea name="description" value="{{old('description', $car->description?? null)}}" cols="30" rows="10" placeholder="Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It" class="text-sm md:text-base bg-white p-4 w-full"></textarea>
                        @error('description')
                                <span class="error-validate">- {{ $message }}</span>
                        @enderror
                        <div class="counter">
