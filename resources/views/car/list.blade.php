...
<div class="dashboard__container  py-4 lg:py-7 px-4 lg:px-8">
					...
					<div class="head__filter flex-col xl:flex-row flex items-start xl:items-center justify-between mb-4 md:mb-7">
						<h6 class="font-medium m-0  text-base lg:text-lg dark__grey">Mes encheres</h6>
					...
					<div class="filter__container px-3 md:px-6 pt-5 md:pt-6 pb-5 md:pb-10 bg-white rounded-md">
						<form action="" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-4  gap-y-3 sm:gap-y-4 md:gap-y-8">
							<div class="group__input group__dropdown relative">
								...
								<input type="hidden">
								<a href="#" class="h-10 inline-flex items-center  justify-start relative w-full"><span class="text-sm">Toyota</span> <img src="img/arrowdown.svg" alt="arrowdown" class="arrow"></a>
								<div class="dropdown__box">
									<ul class="px-2 py-2">
									  <li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="1">
										  <span class="checkmark mr-2"></span> 1
										</label>
									</li>
										<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="2">
										  <span class="checkmark mr-2"></span> 2
										</label>
									</li>
									<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="3">
										  <span class="checkmark mr-2"></span> 3
										</label>
									</li>
									<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="42">
										  <span class="checkmark mr-2"></span> 42
										</label>
									</li>
									<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="5">
										  <span class="checkmark mr-2"></span> 5
										</label>
									</li>
									<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="6">
										  <span class="checkmark mr-2"></span> 6
										</label>
									</li>
									<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="7">
										  <span class="checkmark mr-2"></span> 7
										</label>
									</li>
									<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="8">
										  <span class="checkmark mr-2"></span>8
										</label>
									</li>
									<li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="9">
										  <span class="checkmark mr-2"></span> 9
										</label>
									</li>
									</ul>
								</div>
							...
							<div class="group__input group__dropdown relative">
								...
								<input type="hidden">
								<a href="#" class="h-10 inline-flex items-center  justify-start relative w-full"><span class="text-sm">Avalon</span> <img src="img/doublearrow.svg" alt="arrowdown"></a>
								<div class="dropdown__box">
									<ul class="px-2 py-2">
									  <li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="1">
							...
							<div class="group__input group__dropdown relative">
								<p class="font-semibold mb-1 text-sm">City</p>
								<input type="hidden">
								<a href="#" class="h-10 inline-flex items-center  justify-start relative w-full"><span class="text-sm">Marrakech</span> <img src="img/arrowdown.svg" alt="arrowdown" class="arrow"></a>
								<div class="dropdown__box">
									<ul class="px-2 py-2">
									  <li class="flex w-full px-2 py-2"><label class="container__input cursor-pointer  flex items-center justify-start text-sm w-full">
										  <input type="checkbox" data-value="1">
							...
							<div class="group__input group__dropdown relative">
								<p  class="font-semibold mb-1 text-sm">Date added</p>
								<input type="hidden">
								<a href="#" class="h-10 inline-flex items-center  justify-start relative w-full"><span class="text-sm">May</span> <img src="img/arrowdown.svg" alt="arrowdown" class="arrow"></a>
								<div class="dropdown__box">
									<ul class="px-2 py-2">
							...
							<div class="group__input group__dropdown relative">
								...
								<input type="hidden">
								<a href="#" class="h-10 inline-flex items-center  justify-start relative w-full"><span class="text-sm">WW in Morocco</span> <img src="img/arrowdown.svg" alt="arrowdown" class="arrow"></a>
								<div class="dropdown__box">
									<ul class="px-2 py-2">
										<li class="flex w-full"><a class="flex w-full items-center justify-start px-2 py-2 rounded-md text-sm" href="#">1</a></li>
										<li class="flex w-full"><a class="flex w-full items-center justify-start px-2 py-2 rounded-md text-sm" href="#">2</a></li>
							...
							<div class="group__input relative range__group">
								...
								<div class="values__range flex items-center justify-between">
									...
									<p class="text-sm font-medium">2022</p>
								</div>
								<div class="info__range flex items-center justify-between">
									<p class="m-0 text-sm dark__grey">Le minimum</p>
									<p class="m-0 text-sm dark__grey">Max</p>
