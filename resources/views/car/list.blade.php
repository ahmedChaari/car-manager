				...
				@foreach($cars as $car)
					<a href="#" class="elem__gallery bg-white">
						<div class="image__gallery flex items-center justify-center relative">
							<span class="views inline-flex items-center justify-center px-2 py-1 font-medium"><img src="img/views.svg" class="mr-1" alt="views"> {{ $car->number_view }}</span>
						...
						<div class="gallery__desc px-3 pt-2 pb-3">
							...
							<ul class="flex items-center justify-start flex-wrap">
								<li  class="text-sm  mr-3 light__grey">Date Limite: <span class="dark__grey font-semibold">{{ $car->created_at->diffForHumans() }}</span></li>
