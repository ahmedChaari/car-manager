        ...
        <div class="container__wrapper mx-auto px-4">
            <div class="outer__header  py-2  lg:py-3 flex items-center justify-between">
                <div class="header__left flex items-center justify-start">
                    <a href="#" class="inline-flex items-center justify-center"><img src="{{ @asset('assets/img/smallheader.svg') }}" alt="smallheader"></a>
                    <div class="header__menu">
                        <ul class="flex items-center justify-start">
                            ...
                            <li class="dropdown__menu relative py-2 lg:py-3" >
                                <a href="#" class="font-semibold text-base inline-flex items-center justify-center">Finance <span class="inline-flex items-center ml-2"><img src="{{ @asset('assets/img/headerarrow.svg') }}" alt="headerarrow"></span></a>
                ...
                <div class="header__right flex items-center justify-end">
                    <a href="{{ route('sellers.create') }}" class="regular-btn h-12 py-3 px-5 text-white font-semibold rounded-md whitespace-nowrap inline-flex">sell my car</a>
            ...
            <div class="outer__home">
                <div class="home__box">
                        ...
                        <form action="" class="w-full">
                            <div class="group__wrapper flex items-center w-full mt-4 sm:mt-8 xl:mt-12">
                                <div class="group__input group__dropdown relative w-full flex items-center mr-4">
                                    <input type="hidden">
                                    <a href="#" class="h-12 inline-flex items-center  justify-start relative w-full"><span class="text-sm not__active">Marque de ma voiture</span> <img src="/assets/img/arrowdown.svg" alt="arrowdown" class="arrow"></a>
                    ...
                    <div class="list__home mt-4 sm:mt-8 xl:mt-12">
                        <ul>
                            <li class="flex items-center justify-start mb-3 md:mb-5 text-sm sm:text-base md:text-lg"><span class="inline-flex items-center justify-center mr-3 "><img src="/assets/img/checkhero.svg" alt="checkhero"></span> Formulaire facile à remplir.</li>
                            <li class="flex items-center justify-start mb-3 md:mb-5 text-sm sm:text-base md:text-lg"><span class="inline-flex items-center justify-center mr-3 "><img src="/assets/img/checkhero.svg" alt="checkhero"></span> Recevez des prix raisonnables.</li>
                            <li class="flex items-center justify-start text-sm sm:text-base md:text-lg"><span class="inline-flex items-center justify-center mr-3 "><img src="/assets/img/checkhero.svg" alt="checkhero"></span> Vendez votre voiture sur place.</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="outer__offers">
                ...
                <div class="offers__main flex flex-col-reverse lg:flex-row items-center justify-between">
                    <div class="offers__list mt-4 lg:mt-0 mr-0 lg:mr-12 w-full">
                        <div class="el__offer py-4 pr-4">
                            ...
                            <div class="offer__button flex items-center justify-start">
                                <a href="#" class="inline-flex items-center  text-sm lg:text-base font-semibold">Apprendre encore plus <span class="inline-flex ml-2"><img src="/assets/img/offerarrow.svg" alt="offer"></span></a>
                            </div>
                        </div>
                        <div class="el__offer py-4 pr-4">
                    ...
                    <div class="offers__image inline-flex">
                        <img src="/assets/img/offerimage.webp" alt="offerimage">
                    </div>
                </div>
            </div>
        </div>
