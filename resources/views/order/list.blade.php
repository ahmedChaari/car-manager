...
<div class="dashboard__container  py-4 lg:py-7 px-4 lg:px-8">
					<div class="head__filter flex-col md:flex-row flex items-start md:items-center justify-between mb-4 md:mb-7">
						...
						<div class="controls__tab flex items-center justify-end mt-3 md:mt-0 ml-0 md:ml-4">
							...
							<g clip-path="url(#clip0_58_19260)">
							<path d="M20 10C20 10.9217 19.92 11.6667 18.9983 11.6667H11.6667V18.9983C11.6667 19.9183 10.9217 20 10 20C9.07833 20 8.33333 19.9183 8.33333 18.9983V11.6667H1.00167C0.0816664 11.6667 0 10.9217 0 10C0 9.07833 0.0816664 8.33333 1.00167 8.33333H8.33333V1.00167C8.33333 0.0799998 9.07833 0 10 0C10.9217 0 11.6667 0.0799998 11.6667 1.00167V8.33333H18.9983C19.92 8.33333 20 9.07833 20 10Z" fill="#374151"/>
							</g>
							<defs>
							<clipPath id="clip0_58_19260">
				...
				<div class="table__wrapper w-full mt-4 md:mt-7">
						<table class="regular-table w-full">
							...
							<tr class="bg-white">
								...
								<td  class="px-6 py-3">
									<p class="text-sm light__grey">Mar. 31, 2008</p>
								</td>
								<td   class="px-6 py-3">
								...
								<td  class="px-6 py-3 text-center">
									<div class="payment__status flex items-center justify-center">
										...
										<p class="canceled text-xs font-medium">Canceled</p>
                                        @else($payment->status = false)
                                        <p class="canceled text-xs font-medium">gg</p>
                                        @endif
									</div>
								</td>
								<td  class="px-6 py-3 text-center" title="Mise à jour">
									<div class="edit__button flex items-center justify-center">
										<a href="#" title="Mise à jour" ><img src="img/editor.svg" alt="edit"></a>
									</div>
								</td>
								<td  class="px-6 py-3 text-center">
